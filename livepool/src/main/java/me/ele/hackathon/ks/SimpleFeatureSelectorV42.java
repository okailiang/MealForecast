 ...
 */
public class SimpleFeatureSelectorV42 {
    private static final Logger log = LoggerFactory.getLogger(SimpleFeatureSelectorV42.class);

    public String VERSION = "simple_feature_selector_v42";
    ...
    public SimpleFeatureSelectorV42() {
        this.clickTimes = 12;
        this.buyTimes = 100;
    ...
    public static DatasetFile buildDataset(boolean recreateFile) {
        SimpleFeatureSelectorV42 selector = null;
        try {
            selector = new SimpleFeatureSelectorV42();
            if (recreateFile) {
