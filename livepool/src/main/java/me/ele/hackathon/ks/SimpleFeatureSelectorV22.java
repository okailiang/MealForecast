 ...
 * 可变扩容比例的dataset
 */
public class SimpleFeatureSelectorV22 {
    private static final Logger log = LoggerFactory.getLogger(SimpleFeatureSelectorV22.class);

    public String VERSION = "simple_feature_selector_v22";
    ...
    public SimpleFeatureSelectorV22(int clickTimes, int buyTimes) {
    ...
    public static DatasetFile buildDataset(int clickTimes, int buyTimes, boolean recreateFile) {
        ...
        SimpleFeatureSelectorV22 selector = null;
        try {
            selector = new SimpleFeatureSelectorV22(clickTimes, buyTimes);
        ...
        return new DatasetFile(selector.VERSION,
                selector.CLICK_EXPAND_OUTPUT_File, selector.CLICK_ORIGIN_OUTPUT_File,
                selector.BUY_EXPAND_OUTPUT_File, selector.BUY_ORIGIN_OUTPUT_File,
                selector.TEST_OUTPUT_File, 11);
    }
    ...
    private void formatTrainDataset(String info, String env,
        ...
        log.warn("done. 扩容后size: {},  click: {}/(origin){}, buy:: {}/(origin){}, click_rate: {}, buy_rate: {}. ",
                expandAds.size(), expandClickCount, originClickCount, expandBuyCount, originBuyCount,
                (double) expandClickCount / expandAds.size(), (double) expandBuyCount / expandAds.size());
...
//                "click_rate: " + originClickCount / ads.size() + ", buy_rate: " + originBuyCount / ads.size());
        ...
        log.warn("Format Train Dataset File ok, clickOutput: {}, buyOutput: {}", clickExpand, buyExpand);
    }
