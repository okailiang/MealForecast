 ...
 * Time: 上午11:47
 */
public class SimpleFeatureSelectorV32 {
    private static final Logger log = LoggerFactory.getLogger(SimpleFeatureSelectorV32.class);

    public String VERSION = "simple_feature_selector_v32";
    ...
    public SimpleFeatureSelectorV32(int clickTimes, int buyTimes) {
    ...
    public static DatasetFile buildDataset(int clickTimes, int buyTimes, boolean recreateFile) {
        SimpleFeatureSelectorV32 selector = null;
        try {
            selector = new SimpleFeatureSelectorV32(clickTimes, buyTimes);
            if (recreateFile) {
