 ...
 */
@Deprecated
public class SimpleFeatureSelectorV2 {
    private static final Logger log = LoggerFactory.getLogger(SimpleFeatureSelectorV2.class);

    public static final String VERSION = "simple_feature_selector_v2";
    ...
    public static final String CLICK_OUTPUT_File = FEATURE_DATA_DIR + VERSION+ "/click_train.txt";
    public static final String BUY_OUTPUT_File = FEATURE_DATA_DIR + VERSION+ "/buy_train.txt";
    public static final String TEST_OUTPUT_File = FEATURE_DATA_DIR + VERSION+ "/test.txt";
    ...
    public static DatasetFile buildDataset() {
        ...
        return new DatasetFile("simple_feature_selector_v2", CLICK_OUTPUT_File, BUY_OUTPUT_File, TEST_OUTPUT_File, 11);
    }
